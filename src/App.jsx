...
const style = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .nav-logo {
    ...
    font-weight: 700; color: var(--gold); letter-spacing: 2px; text-decoration: none;
  }
  .nav-logo span { color: var(--text); font-weight: 400; }
  .nav-links { display: flex; gap: 40px; list-style: none; }
  .nav-links a {
    text-decoration: none; color: var(--text2); font-size: 13px;
  ...
  .nav-cta {
    ...
    cursor: none; transition: all 0.3s; font-family: 'DM Sans', sans-serif;
  }
  ...
  .hero-badge {
    ...
    margin-bottom: 40px; font-size: 11px; letter-spacing: 3px;
  ...
  .hero-title {
    ...
    font-size: clamp(52px, 7vw, 90px); line-height: 1.0;
  ...
  .hero-sub {
    font-size: 16px; color: var(--text2); line-height: 1.8; max-width: 500px;
    margin-bottom: 50px; font-weight: 300;
    animation: fadeUp 0.8s 0.4s ease both;
  }
  .hero-actions { display: flex; gap: 20px; animation: fadeUp 0.8s 0.6s ease both; }
  .btn-primary {
    padding: 16px 44px; background: var(--gold); color: var(--bg);
    font-size: 13px; letter-spacing: 2px; text-transform: uppercase;
    cursor: none; border: none; font-family: 'DM Sans', sans-serif;
    font-weight: 500; transition: all 0.3s; position: relative; overflow: hidden;
  }
  .btn-primary::before {
    content: ''; position: absolute; inset: 0;
    background: var(--gold-light); transform: translateX(-100%); transition: transform 0.3s;
  }
  .btn-primary:hover::before { transform: translateX(0); }
  .btn-primary span { position: relative; z-index: 1; }
  .btn-ghost {
    padding: 16px 44px; background: transparent; color: var(--text);
    font-size: 13px; letter-spacing: 2px; text-transform: uppercase;
    cursor: none; border: 1px solid var(--border); font-family: 'DM Sans', sans-serif;
  ...
  .stat-card {
    border: 1px solid var(--border); padding: 30px 40px;
  ...
  .marquee-item {
    ...
    font-size: 12px; letter-spacing: 3px; color: var(--text3); text-transform: uppercase;
    white-space: nowrap;
  }
  ...
  .section-label {
    ...
    color: var(--gold); margin-bottom: 16px; display: flex; align-items: center; gap: 16px;
  }
  .section-label::before { content: ''; width: 40px; height: 1px; background: var(--gold); }
  .section-title {
    font-family: 'Playfair Display', serif;
    font-size: clamp(36px, 4vw, 56px); font-weight: 700; line-height: 1.15;
    margin-bottom: 20px;
  }
  ...
  /* SEARCH BAR */
  .search-section {
    background: var(--bg2); padding: 60px;
    border-top: 1px solid var(--border); border-bottom: 1px solid var(--border);
  }
  .search-tabs { display: flex; gap: 0; margin-bottom: 30px; }
  .search-tab {
    padding: 12px 30px; font-size: 12px; letter-spacing: 2px;
    text-transform: uppercase; cursor: none; border: 1px solid var(--border);
    background: transparent; color: var(--text2); transition: all 0.3s;
    font-family: 'DM Sans', sans-serif; margin-right: -1px;
  }
  ...
  .search-field input, .search-field select {
    ...
    color: var(--text); font-size: 14px; font-family: 'DM Sans', sans-serif; cursor: none;
  }
  .search-field select option { background: var(--bg3); }
  .search-btn {
    padding: 20px 40px; background: var(--gold); color: var(--bg);
    border: none; font-size: 12px; letter-spacing: 2px; text-transform: uppercase;
    cursor: none; font-family: 'DM Sans', sans-serif; font-weight: 500; transition: background 0.3s;
  }
  ...
  .prop-img-inner {
    ...
    font-size: 80px; transition: transform 0.5s ease;
  }
  ...
  .prop-verified {
    ...
    background: rgba(8,8,8,0.8); border: 1px solid var(--green);
    color: var(--green); font-size: 10px; letter-spacing: 1px; text-transform: uppercase;
  ...
  .feat-card {
    padding: 48px 36px; background: var(--surface); position: relative; overflow: hidden;
  ...
  .feat-icon {
    font-size: 44px; margin-bottom: 28px; display: block;
  ...
  .feat-num {
    ...
    color: rgba(201,168,76,0.06); font-weight: 900; line-height: 1;
  }
  ...
  .city-card {
    ...
    background: var(--bg2); display: flex; align-items: flex-end; cursor: none;
    transition: all 0.4s;
  }
  .city-card:first-child { grid-column: span 2; height: 380px; }
  .city-bg {
    position: absolute; inset: 0; font-size: 100px;
    display: flex; align-items: center; justify-content: center;
    filter: grayscale(0.5); transition: transform 0.5s, filter 0.5s;
  }
  ...
  .city-badge {
    position: absolute; top: 16px; right: 16px; padding: 6px 14px;
    background: var(--gold); color: var(--bg); font-size: 10px; letter-spacing: 1px;
  }
  ...
  .testi-card {
    padding: 44px; background: var(--bg2); position: relative;
    border-top: 2px solid transparent; transition: border-color 0.3s;
  }
  .testi-card:hover { border-top-color: var(--gold); }
  .testi-quote {
    font-family: 'Playfair Display', serif; font-size: 80px; color: var(--gold);
    line-height: 0.6; margin-bottom: 20px; opacity: 0.3;
  }
  .testi-text { font-size: 15px; color: var(--text2); line-height: 1.8; margin-bottom: 30px; font-style: italic; font-family: 'Cormorant Garamond', serif; font-size: 18px; }
  ...
  /* APP SECTION */
  .app-section {
    background: var(--bg2); display: grid; grid-template-columns: 1fr 1fr; gap: 80px;
    align-items: center;
  }
  ...
  .phone-mockup {
    width: 280px; height: 560px; border: 2px solid var(--border);
    border-radius: 36px; background: var(--surface); margin: 0 auto;
    position: relative; overflow: hidden;
  ...
  .phone-emoji { font-size: 36px; text-align: center; display: block; }
  .phone-notch {
    position: absolute; top: 0; left: 50%; transform: translateX(-50%);
    width: 120px; height: 28px; background: var(--bg); border-radius: 0 0 20px 20px;
  }

  /* STATS BANNER */
  .stats-banner {
    background: var(--gold); padding: 60px;
  ...
  .stat-b-num {
    ...
    font-weight: 900; color: var(--bg); display: block;
  }
  ...
  .form-group input, .form-group select, .form-group textarea {
    ...
    color: var(--text); padding: 14px 18px; font-family: 'DM Sans', sans-serif;
    font-size: 14px; outline: none; transition: border-color 0.3s; cursor: none;
  }
  ...
  /* FOOTER */
  footer {
    background: var(--bg2); padding: 80px 60px 40px;
  ...
  .social-btn {
    ...
    display: flex; align-items: center; justify-content: center;
    font-size: 18px; cursor: none; transition: all 0.3s;
  }
  ...
  .modal-close {
    ...
    color: var(--text2); font-size: 20px; cursor: none; transition: all 0.3s;
    display: flex; align-items: center; justify-content: center;
  }
  .modal-close:hover { border-color: var(--gold); color: var(--gold); }
  .modal-body { padding: 44px; }
  .modal-prop-img {
    height: 200px; background: var(--bg3); display: flex; align-items: center;
    justify-content: center; font-size: 80px; margin-bottom: 28px; border: 1px solid var(--border);
  }
  ...
  .modal-detail value { font-size: 16px; font-weight: 500; }
  ...
  .calc-title { font-family: 'Playfair Display', serif; font-size: 28px; font-weight: 700; margin-bottom: 30px; }
  ...
  .calc-group input[type=range]::-webkit-slider-thumb {
    -webkit-appearance: none; width: 16px; height: 16px; background: var(--gold); border-radius: 50%; cursor: none;
  }
  .calc-val { font-family: 'Playfair Display', serif; font-size: 22px; color: var(--gold); }
  .calc-result {
    margin-top: 30px; padding: 28px; background: var(--bg3);
    border: 1px solid var(--gold); display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 0;
  }
  ...
  .award-item {
    flex: 1; padding: 36px 28px; border-right: 1px solid var(--border); text-align: center;
  ...
  .agent-card {
    ...
    border: 1px solid var(--border); transition: all 0.4s; cursor: none;
    position: relative; overflow: hidden;
  }
  .agent-card::before {
  ...
  .blog-cat {
    position: absolute; bottom: 16px; left: 16px; padding: 5px 14px;
    background: var(--gold); color: var(--bg); font-size: 10px; letter-spacing: 2px; text-transform: uppercase;
  }
  ...
  /* NEWSLETTER */
  .newsletter {
    background: linear-gradient(135deg, rgba(201,168,76,0.08) 0%, rgba(8,8,8,0) 60%);
    border-top: 1px solid var(--border); border-bottom: 1px solid var(--border);
    padding: 80px 60px; text-align: center; position: relative; overflow: hidden;
  }
  .newsletter::before {
    content: ''; position: absolute; inset: 0;
    background: radial-gradient(ellipse 60% 100% at 50% 100%, rgba(201,168,76,0.05) 0%, transparent 70%);
  }
  .newsletter-title {
  ...
  .newsletter-form input {
    flex: 1; padding: 18px 24px; background: var(--surface); border: 1px solid var(--border);
    border-right: none; color: var(--text); font-size: 14px; font-family: 'DM Sans', sans-serif;
  ...
  .newsletter-form button {
    ...
    border: none; font-size: 12px; letter-spacing: 2px; text-transform: uppercase;
    cursor: none; font-family: 'DM Sans', sans-serif; font-weight: 500; transition: background 0.3s; white-space: nowrap;
  }
  .newsletter-form button:hover { background: var(--gold-light); }
  .newsletter-note { font-size: 11px; color: var(--text3); margin-top: 16px; letter-spacing: 1px; position: relative; }

  /* PROPERTY TYPES NAV */
  .prop-types { display: flex; gap: 0; overflow-x: auto; margin-top: 50px; border: 1px solid var(--border); }
  .prop-type {
    padding: 18px 32px; font-size: 12px; letter-spacing: 2px; text-transform: uppercase;
    border-right: 1px solid var(--border); white-space: nowrap; cursor: none;
    transition: all 0.3s; color: var(--text2); background: transparent; border-top: none; border-bottom: none; border-left: none;
    font-family: 'DM Sans', sans-serif;
  }
  .prop-type:last-child { border-right: none; }
  .prop-type.active, .prop-type:hover { background: var(--bg3); color: var(--gold); }
  ...
  @media (max-width: 1024px) {
    ...
    .properties-grid, .features-grid { grid-template-columns: repeat(2, 1fr); }
    .cities-grid { grid-template-columns: repeat(2, 1fr); }
    .app-section, .contact { grid-template-columns: 1fr; }
  ...
  .faq-q {
    ...
    align-items: center; gap: 20px; cursor: none;
  }
  .faq-q-text { font-size: 15px; font-weight: 500; line-height: 1.5; }
  .faq-icon {
    width: 32px; height: 32px; border: 1px solid var(--border);
    display: flex; align-items: center; justify-content: center;
    color: var(--gold); font-size: 18px; flex-shrink: 0; transition: transform 0.3s;
  }
  .faq-item.open .faq-icon { transform: rotate(45deg); border-color: var(--gold); }
  .faq-a {
    padding: 0 28px 22px; font-size: 14px; color: var(--text2);
...
export default function App() {
  ...
  const handleContact = (e) => {
    e.preventDefault();
    showToast("Our luxury property advisor will contact you within 2 hours.", "🏆");
  ...
  return (
    <>
          ...
          <div className="modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <div className="modal-details">
                <div className="modal-detail"><label>Price</label><value style={{ color: "var(--gold)", fontFamily: "Playfair Display", fontSize: 22 }}>{selectedProp.price}</value></div>
                <div className="modal-detail"><label>Builder</label><value>{selectedProp.builder}</value></div>
                <div className="modal-detail"><label>Area</label><value>{selectedProp.area} sq.ft</value></div>
                <div className="modal-detail"><label>Possession</label><value>{selectedProp.possession}</value></div>
                <div className="modal-detail"><label>Bedrooms</label><value>{selectedProp.beds} BHK</value></div>
                <div className="modal-detail"><label>RERA ID</label><value style={{ color: "var(--gold)", fontSize: 13 }}>{selectedProp.rera}</value></div>
              </div>
            ...
            <div className="modal-footer">
              <button className="btn-primary" style={{ flex: 1 }} onClick={() => { setSelectedProp(null); showToast("Visit booking confirmed! Agent will call you shortly.", "📅"); }}><span>Book a Visit</span></button>
              <button className="btn-ghost" style={{ flex: 1 }} onClick={() => { showToast("Added to your wishlist.", "❤️"); }}>Add to Wishlist</button>
            </div>
          </div>
        </div>
      )}
      ...
      <nav className={`nav ${scrolled ? "scrolled" : ""}`}>
        ...
        <button className="nav-cta" onClick={() => showToast("Download link sent to your phone!", "📱")}>Download App</button>
      </nav>
      ...
      <section className="hero" id="hero">
        ...
        <div className="hero-content">
          ...
          <p className="hero-sub">
            Discover 50,000+ RERA-verified properties across 100+ Indian cities.
            Buy, sell, or rent with zero brokerage, complete transparency, and AI-powered intelligence.
          </p>
          <div className="hero-actions">
            ...
            <button className="btn-ghost" onClick={() => showToast("Download link sent to your phone!", "📱")}>Download App</button>
          </div>
        </div>
        <div className="hero-stats">
          ...
          <div className="stat-card">
            ...
            <div className="stat-label">RERA Verified</div>
          </div>
        </div>
      </section>
      ...
      <div className="search-section">
        ...
        <div className="search-bar">
          <div className="search-field">
            ...
            <input placeholder="City, area, project..." />
          </div>
          <div className="search-field">
          ...
          <button className="search-btn" onClick={() => showToast("Showing 3,842 properties matching your criteria.", "🔍")}>Search →</button>
        </div>
      </div>
      ...
      <section id="properties" style={{ background: "var(--bg)" }}>
          ...
          {properties.map(prop => (
            <div key={prop.id} className="prop-card" onClick={() => setSelectedProp(prop)}>
              <div className="prop-img">
                ...
                <div className={`prop-badge ${prop.type === "sale" ? "badge-sale" : "badge-rent"}`}>
        ...
        <div style={{ textAlign: "center", marginTop: 60 }}>
          <button className="btn-ghost" style={{ padding: "16px 60px" }} onClick={() => showToast("Loading 50,000+ verified properties...", "🏘️")}>View All Properties</button>
        </div>
      </section>
      ...
      <section id="cities" style={{ background: "var(--bg2)" }}>
        ...
        <div className="cities-grid">
          {cities.map(city => (
            <div key={city.name} className="city-card" onClick={() => showToast(`Exploring ${city.count} properties in ${city.name}`, "🏙️")}>
      ...
      <section id="features" className="features">
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          ...
          <p className="section-sub" style={{ textAlign: "right" }}>Every feature designed around India's complex real estate ecosystem — RERA, home loans, NRI needs, and beyond.</p>
        </div>
      ...
      <section id="process" style={{ background: "var(--bg)" }} className="process">
        ...
        <h2 className="section-title" style={{ textAlign: "center", marginBottom: 0 }}>
          Find Your Dream Home<br /><em style={{ fontStyle: "italic", color: "var(--gold)", fontFamily: "Playfair Display" }}>In 4 Simple Steps</em>
        </h2>
      ...
      <section className="app-section" id="app">
        <div>
          ...
          <p style={{ color: "var(--text2)", fontSize: 15, lineHeight: 1.8, marginBottom: 40, maxWidth: 440 }}>
            Our Flutter-powered Android app brings RERA-verified listings, AI matching, 3D tours, home loan calculators, and direct chat — all in one sleek, fast, secure app.
          </p>
          ...
          <div style={{ marginTop: 40, display: "flex", gap: 16 }}>
            <button className="btn-primary" onClick={() => showToast("APK download started!", "📱")}><span>Download APK</span></button>
          ...
          <div className="phone-mockup">
            ...
            <div className="phone-screen" style={{ paddingTop: 40 }}>
              <div className="phone-header">
                <span className="phone-logo">SmartEstate</span>
              ...
              {[
                ...
                <div key={p.name} className="phone-card">
                  <span className="phone-emoji" style={{ fontSize: 24, display: "inline" }}>{p.emoji}</span>
                  <div className="phone-card-title">{p.name}</div>
      ...
      <section id="rera" className="rera-section">
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          ...
          <p className="section-sub" style={{ textAlign: "right" }}>We connect directly with RERA portals of every state. Every listing is cross-verified before it goes live on our platform.</p>
        </div>
          ...
          {reraStates.map(r => (
            <div key={r.state} className="rera-card">
              ...
              <div style={{ marginTop: 16 }}>
                <span className="rera-link" style={{ cursor: "pointer" }} onClick={() => showToast(`Opening ${r.state} RERA portal...`, "🔗")}>View RERA Portal →</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="calculator">
          <div className="calc-grid">
            ...
            <div className="calc-group" style={{ justifyContent: "flex-end" }}>
              <button className="btn-primary" style={{ width: "100%", marginTop: "auto" }} onClick={() => showToast("Connecting you with 25+ lenders for best rates!", "🏦")}><span>Get Best Loan Offers</span></button>
            </div>
          </div>
      ...
      <section id="contact" className="contact">
        <div>
          ...
          <p style={{ color: "var(--text2)", fontSize: 15, lineHeight: 1.8, maxWidth: 440, marginBottom: 8 }}>Our certified real estate advisors are available 7 days a week, 9 AM – 9 PM across all Indian time zones.</p>
        ...
        <div>
          <form className="contact-form" onSubmit={handleContact}>
            ...
            <div className="form-group">
              <label>Message</label>
              <textarea placeholder="Tell us about your requirements — type of property, preferred area, must-have amenities, timeline..." value={contactForm.message} onChange={e => setContactForm(p => ({ ...p, message: e.target.value }))} />
            </div>
      ...
      <section className="awards">
        ...
        <h2 className="section-title" style={{ textAlign: "center" }}>
          Industry <em style={{ fontStyle: "italic", color: "var(--gold)", fontFamily: "Playfair Display" }}>Awards & Recognition</em>
        </h2>
      ...
      <section style={{ background: "var(--bg)" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          ...
          <p className="section-sub" style={{ textAlign: "right" }}>Certified RERA agents with 10+ years experience across India's top real estate markets.</p>
        </div>
          ...
          {[
            ...
            <div key={a.name} className="agent-card">
              ...
              <div className="agent-langs">
                {a.langs.map(l => <span key={l} className="lang-tag">{l}</span>)}
              </div>
              <button className="btn-view" style={{ width: "100%" }} onClick={() => showToast(`Connecting you with ${a.name}...`, "📞")}>Connect →</button>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{ background: "var(--bg2)" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          ...
          <button className="btn-ghost" style={{ padding: "14px 40px" }} onClick={() => showToast("Opening knowledge hub...", "📚")}>View All Articles</button>
        </div>
        <div className="blog-grid">
          {[
            { emoji: "📈", cat: "Market", date: "Apr 10, 2026", title: "Mumbai Real Estate 2026: Why Prices Are Surging 18% YoY", excerpt: "Expert analysis of why Mumbai's prime markets continue to defy gravity and what it means for buyers and investors in the current cycle." },
            { emoji: "⚖️", cat: "Legal", date: "Apr 8, 2026", title: "RERA 2026 Amendments: What Every Home Buyer Must Know", excerpt: "The new RERA amendments bring stronger penalties for builders and faster refund timelines. Here's what changed and how it protects you." },
            { emoji: "💰", cat: "Finance", date: "Apr 5, 2026", title: "SBI vs HDFC vs ICICI: Best Home Loan Rates in April 2026", excerpt: "A comprehensive comparison of home loan rates, processing fees, and hidden charges across India's top 10 lenders this month." },
          ].map(b => (
            <div key={b.title} className="blog-card">
              ...
              <div className="blog-body">
                ...
                <div className="blog-read" onClick={() => showToast("Opening article...", "📰")}>Read Article →</div>
              </div>
            </div>
          ))}
        </div>
      ...
      {/* TRUST BAND */}
      <div style={{ background: "var(--surface)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)", padding: "40px 60px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 40 }}>
        <div style={{ fontSize: 12, letterSpacing: 3, color: "var(--text3)", textTransform: "uppercase", whiteSpace: "nowrap" }}>Trusted Lending Partners</div>
        <div style={{ display: "flex", gap: 40, alignItems: "center", flex: 1, justifyContent: "center", flexWrap: "wrap" }}>
          {["🏦 SBI", "🏦 HDFC Bank", "🏦 ICICI Bank", "🏦 Axis Bank", "🏦 Kotak Mahindra", "🏦 LIC HFL", "🏦 Bajaj Finserv", "🏦 PNB Housing", "🏦 Tata Capital", "🏦 Indiabulls HFL"].map(b => (
            <div key={b} style={{ fontSize: 13, color: "var(--text3)", whiteSpace: "nowrap", letterSpacing: 1 }}>{b}</div>
          ))}
        </div>
      </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "start" }}>
          <div>
            ...
            <div style={{ marginTop: 40 }}>
              <button className="btn-primary" onClick={() => showToast("Opening full FAQ page...", "❓")}><span>View All FAQs</span></button>
            </div>
          </div>
      ...
      <div className="newsletter">
        ...
        <div className="newsletter-form">
          ...
          <button onClick={() => showToast("Subscribed! Welcome to SmartEstate Insider.", "💌")}>Subscribe</button>
        </div>
        ...
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <div className="footer-socials">
              {["📘", "📸", "🐦", "▶️", "💼"].map((s, i) => (
                <div key={i} className="social-btn" onClick={() => showToast("Opening social media page...", s)}>{s}</div>
              ))}
            </div>
          </div>
          <div className="footer-col">
            ...
            <ul className="footer-links">
              {["Buy Properties", "Rent Properties", "New Projects", "Luxury Homes", "Commercial Spaces", "Plots & Land", "NRI Properties", "Affordable Housing", "Senior Living"].map(l => (
          ...
          <div className="footer-col">
            <h4>Top Cities</h4>
            <ul className="footer-links">
              {["Mumbai", "Bengaluru", "Delhi NCR", "Hyderabad", "Pune", "Chennai", "Kolkata", "Ahmedabad", "Jaipur", "Goa", "Chandigarh", "Kochi"].map(l => (
                <li key={l}><a href="#">{l}</a></li>
              ))}
            </ul>
          </div>
          <div className="footer-col">
            <h4>Company</h4>
            <ul className="footer-links">
              {["About Us", "Our Team", "Careers", "Press & Media", "Blog", "Privacy Policy", "Terms of Service", "RERA Compliance", "Cookie Policy", "Grievance Redressal", "Investor Relations", "Partner with Us"].map(l => (
                <li key={l}><a href="#">{l}</a></li>
              ))}
            </ul>
          </div>
